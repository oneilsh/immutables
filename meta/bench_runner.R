...
.bench_profile <- function(suite = c("quick", "full")) {
  ...
  if(identical(suite, "quick")) {
    return(list(
      ...
      interval_index_queries = list(n = 90L, queries = 45L, coord_space = 180L, width_max = 14L),
      ...
      interval_index_bounds_override = list(n = 90L, queries = 13L, coord_space = 180L, width_max = 14L),
