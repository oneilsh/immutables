testthat::test_that("split_digit handles first/middle/last boundaries", {
  ...
  s1 <- fingertree:::split_digit(function(v) v >= 1, 0, d, ms, "count")
  ...
  s2 <- fingertree:::split_digit(function(v) v >= 2, 0, d, ms, "count")
  ...
  s3 <- fingertree:::split_digit(function(v) v >= 3, 0, d, ms, "count")
...
testthat::test_that("split_digit works when digit holds nodes", {
  ...
  s <- fingertree:::split_digit(function(v) v >= 3, 0, d, ms, "count")
...
testthat::test_that("split_digit errors for invalid preconditions", {
  ...
  testthat::expect_error(
    fingertree:::split_digit(function(v) v >= 1, 0, list(), ms, "count"),
    "empty digit"
  )

  d <- Digit("a", "b")
  testthat::expect_error(
    fingertree:::split_digit(function(v) v >= 10, 0, d, ms, "count"),
